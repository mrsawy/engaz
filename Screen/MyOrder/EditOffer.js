...
class EditOffer extends React.Component {
  ...
  async accept() {
    ...
    if (this.state.price.trim() !== "") {
      fetch(API_URI + "/api/request_edit_offer", {
        method: "POST",
        headers: {
        ...
        .then(async (responseJson) => {
          ...
          if (responseJson.status == "true") {
            showMessage({
              message: i18n.t("edit_msg"),
              description: i18n.t("edit_msg_des"),
              type: "success",
  ...
  //   if(NextProps.data_success && NextProps.data_success !== null && NextProps.data_success !== this.props.data_success){
