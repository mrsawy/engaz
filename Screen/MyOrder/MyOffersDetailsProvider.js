...
class MyOffersDetailsProvider extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      fontLoaded: false,
  ...
  async RequestFinishedOrder(id) {
    this.setState({ finished_fished: true });

    const formData = new FormData();
    formData.append("id", id);

    fetch(API_URI + "/api/request_finished", {
      method: "POST",
      headers: {
      ...
      .then(async (responseJson) => {
        this.setState({ finished_fished: false });
          ...
          <View style={{ margin: 15 }}>
            ...
            >
              ...
              >
                ...
                {this.props.route.params.item.request_cancel !== "yes" &&
                this.props.route.params.item.order_status == "in_progress" ? (
                  <Menu style={{ width: 30, height: 30 }}>
                    ...
                    <MenuOptions>
                      <MenuOption
                        onSelect={() =>
                          this.CancelRequest(this.props.route.params.item.id)
                        }
                        style={{
                          padding: 10,
                          flexDirection:
                      ...
                      <View style={{ flex: 1, justifyContent: "center" }}>
                        ...
                        {this.props.route.params.item.request_edit_price ? (
                          <View>
                            ...
                            >
                              {this.props.route.params.item.offers_price}{" "}
                              {i18n.t("riyal")}
                            </Text>
                            <Text
                              style={{
            ...
            {this.state.page == "Details" ? (
              <ScrollView>
                <View style={{ flex: 1, marginTop: 20 }}>
                  ...
                  {this.props.route.params.item.order_status == "in_progress" &&
                  !this.props.route.params.item.request_finished &&
                  !this.state.request_finished ? (
                    <View>
                      {!this.state.finished_fished ? (
                        <TouchableOpacity
                          onPress={() =>
                            this.RequestFinishedOrder(
                        ...
                        >
                          ...
                          >
                            {i18n.t("request_finished_orders")}
                          </Text>
                        </TouchableOpacity>
                      ) : (
                        <View
